            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('account.update') }}">
                        ...
                        <hr class="my-4">
                        <h5>{{ __('app.change_password') }}</h5>
                        <p class="text-muted small">{{ __('app.leave_blank_to_keep_current_password') }}</p>
                        ...
                        <div class="mb-3">
                            <label for="password-confirm" class="form-label">{{ __('app.confirm_new_password') }}</label>
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" autocomplete="new-password">
                        </div>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit" class="btn btn-primary">
                                {{ __('app.update_account') }}
                            </button>
                        </div>
                    </form>
                </div>
